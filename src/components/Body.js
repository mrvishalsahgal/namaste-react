...
import RestaurantCard, { withLabelData } from "./Restaurantcard.js";
import Shimmer from "./Shimmer.js";
import { Link } from "react-router-dom";
import useOnlineStatus from "../utils/useOnlineStatus";
import UserContext from "../utils/UserContex";

const PromotedRestaurantCard = withLabelData(RestaurantCard);
  ...
  return listOfRestaurants.length === 0 ? (
    ...
    <div className="body">
      <div className="flex justify-center m-5 gap-5">
        ...
        />
        <button
          className="bg-red-500 text-white p-2 m-2 rounded-lg py-2"
          onClick={() => {
